...
BROCOIND=${BITCOIND:-$BINDIR/brocoind}
BROCOINCLI=${BITCOINCLI:-$BINDIR/brocoin-cli}
BROCOINTX=${BITCOINTX:-$BINDIR/brocoin-tx}
WALLET_TOOL=${WALLET_TOOL:-$BINDIR/brocoin-wallet}
BROCOINQT=${BITCOINQT:-$BINDIR/qt/brocoin-qt}
